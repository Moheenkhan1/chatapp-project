    ...
    <div className="h-screen w-screen flex items-center justify-center bg-[#E8E8E8]">
      ...
      <div className="flex items-center  ml-[6.5rem] max-sm:ml-0 max-sm:mt-[-1.5rem]  " >
          <div className="pulse animate-pulseCustom mt-3 h-[2rem] max-sm:h-[1.5rem] w-[2rem] max-sm:w-[1.5rem] rounded-full bg-[#4169E1] "></div>
            <h2 className="mt-3 ml-auto max-sm:mt-1 max-sm:ml-[-1.5rem] text-3xl sm:text-xs md:text-xl md:ml-[-7rem] max-lg:ml-[-7rem] lg:ml-[1rem] font-extrabold text-[#4169E1] whitespace-nowrap text-left">
              Chat App Project
            </h2>
          </div>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4 mt-10 max-sm:mt-0 ">
            <div>
          ...
          <div className="flex flex-col text-center" >
              <button
                className="custom-class shadow-lg shadow-indigo-500/50 ml-[9.2rem] max-sm:ml-[3.7rem] md:ml-[3.5rem] max-lg:ml-[3rem] lg:ml-[8rem] mt-9 max-sm:mt-[-1rem] w-[40%]  p-[10px] rounded-[10px] text-[#fff] text-[1.2rem] max-sm:text-[0.8rem] bg-[royalblue] hover:bg-[#385AC2]  "
              >
                Login
              </button>
